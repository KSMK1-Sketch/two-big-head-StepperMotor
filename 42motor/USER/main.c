...
int main(void)
{
    ...
    while (1)
    {
        LED_Test();
            ...
            Emm_V5_Vel_Control(UART_1_INST, 1, 0, 100, 10, 0);

            Emm_V5_Pos_Control_1(UART_0_INST, 1, 0, 25, 10, 3200, 0, 0);

            delay_ms(5000);
            Emm_V5_Vel_Control(UART_1_INST, 1, 1, 50, 10, 0);

            Emm_V5_Pos_Control_1(UART_0_INST, 1, -1, 25, 10, 3200, 0, 0);
