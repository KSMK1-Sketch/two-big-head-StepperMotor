...
#define CIN1_OUT(X)  ( (X) ? (DL_GPIO_setPins(TB6612_PORT,TB6612_CIN1_PIN)) : (DL_GPIO_clearPins(TB6612_PORT,TB6612_CIN1_PIN)) )
#define CIN2_OUT(X)  ( (X) ? (DL_GPIO_setPins(TB6612_PORT,TB6612_CIN2_PIN)) : (DL_GPIO_clearPins(TB6612_PORT,TB6612_CIN2_PIN)) )

#define DIN1_OUT(X)  ( (X) ? (DL_GPIO_setPins(TB6612_PORT,TB6612_DIN1_PIN)) : (DL_GPIO_clearPins(TB6612_PORT,TB6612_DIN1_PIN)) )
#define DIN2_OUT(X)  ( (X) ? (DL_GPIO_setPins(TB6612_PORT,TB6612_DIN2_PIN)) : (DL_GPIO_clearPins(TB6612_PORT,TB6612_DIN2_PIN)) )
